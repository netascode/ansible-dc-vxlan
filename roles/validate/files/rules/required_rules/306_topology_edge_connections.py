class Rule:
    ...
    def match(cls, inventory):
        ...
        # [_dict for _dict in edge_connections if _dict not in found_edge_connections]
            results.append("the follow edge connections have a source device which is topology.switches "+ str([_dict for _dict in edge_connections if _dict not in found_edge_connections]))
