    ...
    def match(cls, data_model):
        ...
        if dm_fabric_type:
            ...
            if fabric_type in ["ibgp", "external"]:
                ...
                # {'keys_found': ['vxlan', 'global'], 'keys_not_found': ['ibgp'], 'keys_data': ['vxlan', 'global'], 'keys_no_data': ['bgp_asn']}
                # {'keys_found': ['vxlan', 'global', 'ibgp'], 'keys_not_found': ['bgp_asn'], 'keys_data': ['vxlan', 'global', 'ibgp'], 'keys_no_data': ['bgp_asn']}
                ...
                # {'keys_found': ['vxlan', 'global', 'bgp_asn'], 'keys_not_found': [], 'keys_data': ['vxlan', 'global'], 'keys_no_data': ['bgp_asn']}
            ...
            if fabric_type in ["ebgp"]:
                # Examples:
                # {'keys_found': ['vxlan', 'global', 'ebgp'], 'keys_not_found': ['spine_bgp_asn'], 'keys_data': ['vxlan', 'global', 'ebgp'], 'keys_no_data': []}
                ...
                # Examples:
                # {'keys_found': ['vxlan', 'global', 'ebgp', 'spine_bgp_asn'], 'keys_not_found': [], 'keys_data': ['vxlan', 'global', 'ebgp'], 'keys_no_data': ['spine_bgp_asn']}
